...
export default function BackgroundEffects() {
  ...
  return <canvas ref={canvasRef} className="fixed inset-0 pointer-events-none -z-10 sm:overflow-x-hidden md:w-full h-full md:max-w-full max-h-full overflow-hidden"
  style={{display:'block'}} />
}
